...
registerApplication({
  ...
  description:
    "Automotive customer experience and operational intelligence platform.",
  ...
  metadata: {
    applicationType: "automotive-saas",
  },
});
...
registerApplication({
  ...
  description:
    "Utility, treasury, funding, and community participation platform.",
